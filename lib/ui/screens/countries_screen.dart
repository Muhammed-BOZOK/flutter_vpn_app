        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              padding: getPadding(
                  left: AppSize.padding2x, right: AppSize.padding2x, top: AppSize.padding2x, bottom: AppSize.padding),
              child: Column(
                children: [
                  Text(
                    "Connecting Time",
                  ...
                  Obx(() => Column(
                        children: [
                          ...
                          SizedBox(
                            height: getDynamicHeight(AppSize.padding2x),
                          ),
                          SizedBox(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: CustomListTile(
                                    ...
                                    title:
                                        vpnController.connectionStats.value.connectedCountry?.name ?? 'Not Connected',
                                    ...
                                    trailing: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          vpnController.connectionStats.value.connectedCountry?.strength.toString() ??
                                              '0',
